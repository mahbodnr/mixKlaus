...
parser.add_argument("--lr-scheduler", default="cosine", type=str, choices=["cosine_restart", "cosine", "none"])
parser.add_argument("--lr-warmup-epochs", default=5, type=int, help="Number of warmup epochs for the learning rate. Set to 0 to disable warmup.")
parser.add_argument("--lr-scheduler-T-max", default=None, type=int, help="T_max parameter for the cosine scheduler. By default (None), it is set to max_epochs.")
parser.add_argument("--lr-scheduler-T-mult", default=1., type=float, help="T_mult parameter for the cosine_restart scheduler.")
parser.add_argument("--lr-scheduler-T-0", default=50, type=int, help="T_0 parameter for the cosine_restart scheduler.")
parser.add_argument("--lr-scheduler-last-epoch", default=-1, type=int, help="Last epoch parameter for the cosine scheduler.")
parser.add_argument("--lr-scheduler-stop-epoch", default=None, type=int, help="Disable the scheduler after this epoch. By default (None), it is not applied.")
...
parser.add_argument("--random-crop-padding", default=4, type=int, help="Padding for random crop augmentation. If 0, no random crop is applied.")
...
parser.add_argument("--normalize-hidden-off", action="store_false", dest="normalize_hidden")
...
parser.add_argument("--nnmf-output", default="hidden", type=str, choices=["hidden", "reconstruction"])
parser.add_argument(
    "--nnmf_backward",
    type=str,
    default="all_grads",
